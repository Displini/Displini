...
export default function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    const existingEmail = 'soulaimanmeskini@gmail.com';
  ...
  return (
    <div className="min-h-screen flex bg-gray-50">
      <SEO
        title="Sign Up"
        description="Create your Displini account to start tracking your health and productivity."
        url="https://displini.com/signup"
      />
        ...
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h2 className="text-3xl font-bold text-gray-900">
              Create your <GradientText>Displini</GradientText> account
            </h2>
            <p className="mt-2 text-gray-600">
              Get started with your personalized health and productivity dashboard
            </p>
          </motion.div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    // Check password match in real-time if confirm password is filled
                  ...
                  className={`pl-12 pr-12 h-12 rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${
                    passwordError && confirmPassword ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''
                  }`}
