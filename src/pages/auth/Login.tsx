...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const validEmail = 'soulaimanmeskini@gmail.com';
    const validPassword = 'appeltaart';
    ...
    try {
      ...
      // Force a page reload to ensure auth state is properly recognized by Router
        ...
        <div className="w-full max-w-md">
          ...
          >
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (hasAttempted) setError('');
                  }}
                  className={`pl-12 h-12 rounded-xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 ${
                    hasAttempted && error ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : ''
                  }`}
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-full font-medium text-base transition-all duration-300 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
